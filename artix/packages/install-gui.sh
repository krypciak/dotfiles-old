...
function install_gui() {
    echo 'alacritty breeze breeze-gtk breeze-icons feh lxappearance qt5-base qt6-base xdg-desktop-portal zenity xdg-utils gtk2 gtk3 qt5ct kolourpaint mpv tutanota-desktop-bin world/gnome-keyring aerc pandoc-bin'
